...
def load_data():
    ...
    mock_data = """
    IR,0x4,0x12,0x0001,2,0,0,0,sendHttpToAPI,0,0,0,0,0,0,0,Test1
    IR,0x8,0x6,0x0002,0,0,0,0,sendIR,0x2,0x6,0x0002,1,0,0,1,Test2
    USB,0x88,0x6,0x0003,0,0x3,0x4,2,sendIR,0x2,0x1,0x0002,1,0,0,1,Test3
    sendToApi=true
    APIHost=http://192.168.10.3:8125/api/webhook/myid
    """
